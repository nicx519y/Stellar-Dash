...
const copy = {
  zh: {
    ...
    pair: '配对', pairing: '正在配对…', paired: '已配对', unpaired: '未与此 XORA 配对',
    resume: '继续完成配对', cancel: '取消未完成配对', incomplete: '配对未完成', address: '连接地址', id: '设备标识',
    unassigned: '未分配', replace: '将替换原有配对关系。', host: '请先连接 XORA。',
    ...
    busy: '设备正忙，请完成其他操作后重试。', conflict: '存在其他未完成的配对，请连接原来的 XORA 和接收器继续完成。',
  ...
  en: {
    ...
    pair: 'Pair', pairing: 'Pairing…', paired: 'Paired', unpaired: 'Not paired with this XORA',
    ...
    unassigned: 'Unassigned', replace: 'This replaces the previous pairing.', host: 'Connect XORA first.',
    ...
    busy: 'Device is busy. Finish the other operation first.', conflict: 'Another pairing is incomplete. Reconnect its original XORA and receiver to finish.',
