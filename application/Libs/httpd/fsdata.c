...
static uint8_t* data___next_static_js_app_layout_f14f37f6143efe34_js = NULL;
static uint8_t* data___next_static_js_app_page_90d41bf184029833_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_F14F37F6143EFE34_JS 323721
#define SIZE___NEXT_STATIC_JS_APP_PAGE_90D41BF184029833_JS 246667
...
struct fsdata_file file___next_static_js_app_layout_f14f37f6143efe34_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_F14F37F6143EFE34_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_90d41bf184029833_js[] = {{
    file___next_static_js_app_layout_f14f37f6143efe34_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_90D41BF184029833_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_90d41bf184029833_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_f14f37f6143efe34_js)->name = data___next_static_js_app_layout_f14f37f6143efe34_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_f14f37f6143efe34_js)->data = data___next_static_js_app_layout_f14f37f6143efe34_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_90d41bf184029833_js)->name = data___next_static_js_app_page_90d41bf184029833_js;
    ((struct fsdata_file *)file___next_static_js_app_page_90d41bf184029833_js)->data = data___next_static_js_app_page_90d41bf184029833_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_f14f37f6143efe34_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_90d41bf184029833_js = (uint8_t*)addr;
        addr += size;
