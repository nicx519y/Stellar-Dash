...
HARDWARE_VERSION = 0x00020000  # 2.0.0 (latest PCB)
FIRMWARE_SECURITY_VERSION = 1
FIRMWARE_SIGNATURE_NONE = 0
FIRMWARE_SIGNATURE_ECDSA_P256_SHA256 = 1
...
METADATA_CRC32_OFFSET = 16
FIRMWARE_HASH_OFFSET = 643
FIRMWARE_SIGNATURE_OFFSET = 675
FIRMWARE_SIGNATURE_ALGORITHM_OFFSET = 739
FIRMWARE_SECURITY_VERSION_OFFSET = 743
FIRMWARE_WEBRESOURCES_OPTIONAL_OFFSET = 747
...
EXTERNAL_FLASH_SIZE = 0x00800000
...
LOG_STORAGE_ADDR = 0x90580000
LOG_STORAGE_SIZE = 0x10000

APP_CONFIG_ADDR = 0x90590000
APP_CONFIG_SIZE = 0x10000

ADC_COMMON_CONFIG_ADDR = 0x905A0000
ADC_COMMON_CONFIG_SIZE = 0x10000

SYS_IMAGE_RESOURCES_ADDR = 0x905B0000
SYS_IMAGE_RESOURCES_SIZE = 0x40000  # 256KB

USER_IMAGE_RESOURCES_ADDR = 0x905F0000
USER_IMAGE_RESOURCES_SIZE = 0x190000  # 1.5625MB; top 512KB is CH585 staging

CH585_FIRMWARE_STAGING_ADDR = 0x90780000
CH585_FIRMWARE_STAGING_SIZE = 0x80000
CH585_FIRMWARE_STAGING_HEADER_SIZE = 0x10000
CH585_FIRMWARE_STAGING_DATA_ADDR = 0x90790000
CH585_FIRMWARE_STAGING_DATA_SIZE = 0x70000
