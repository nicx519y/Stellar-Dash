...
static uint8_t* data___next_static_js_app_layout_5a83aa388b5609a8_js = NULL;
static uint8_t* data___next_static_js_app_page_a7a5b135cf1c8489_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_5A83AA388B5609A8_JS 363524
#define SIZE___NEXT_STATIC_JS_APP_PAGE_A7A5B135CF1C8489_JS 296645
...
struct fsdata_file file___next_static_js_app_layout_5a83aa388b5609a8_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_5A83AA388B5609A8_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_a7a5b135cf1c8489_js[] = {{
    file___next_static_js_app_layout_5a83aa388b5609a8_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_A7A5B135CF1C8489_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_a7a5b135cf1c8489_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_5a83aa388b5609a8_js)->name = data___next_static_js_app_layout_5a83aa388b5609a8_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_5a83aa388b5609a8_js)->data = data___next_static_js_app_layout_5a83aa388b5609a8_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_a7a5b135cf1c8489_js)->name = data___next_static_js_app_page_a7a5b135cf1c8489_js;
    ((struct fsdata_file *)file___next_static_js_app_page_a7a5b135cf1c8489_js)->data = data___next_static_js_app_page_a7a5b135cf1c8489_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_5a83aa388b5609a8_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_a7a5b135cf1c8489_js = (uint8_t*)addr;
        addr += size;
