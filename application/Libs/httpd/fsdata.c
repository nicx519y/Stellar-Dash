...
static uint8_t* data___next_static_js_app_layout_bb8debd2f0ba8342_js = NULL;
static uint8_t* data___next_static_js_app_page_24a757ca29263e10_js = NULL;
...
#define SIZE__INDEX_HTML 23430
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_BB8DEBD2F0BA8342_JS 350281
#define SIZE___NEXT_STATIC_JS_APP_PAGE_24A757CA29263E10_JS 272222
...
struct fsdata_file file___next_static_js_app_layout_bb8debd2f0ba8342_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_BB8DEBD2F0BA8342_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_24a757ca29263e10_js[] = {{
    file___next_static_js_app_layout_bb8debd2f0ba8342_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_24A757CA29263E10_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_24a757ca29263e10_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_bb8debd2f0ba8342_js)->name = data___next_static_js_app_layout_bb8debd2f0ba8342_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_bb8debd2f0ba8342_js)->data = data___next_static_js_app_layout_bb8debd2f0ba8342_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_24a757ca29263e10_js)->name = data___next_static_js_app_page_24a757ca29263e10_js;
    ((struct fsdata_file *)file___next_static_js_app_page_24a757ca29263e10_js)->data = data___next_static_js_app_page_24a757ca29263e10_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_bb8debd2f0ba8342_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_24a757ca29263e10_js = (uint8_t*)addr;
        addr += size;
