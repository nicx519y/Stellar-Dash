...
static uint8_t* data___next_static_js_app_layout_63f4be220d6fa91c_js = NULL;
static uint8_t* data___next_static_js_app_page_84655f75e18f54d7_js = NULL;
...
#define SIZE__INDEX_HTML 17622
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_63F4BE220D6FA91C_JS 364116
#define SIZE___NEXT_STATIC_JS_APP_PAGE_84655F75E18F54D7_JS 297286
...
struct fsdata_file file___next_static_js_app_layout_63f4be220d6fa91c_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_63F4BE220D6FA91C_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_84655f75e18f54d7_js[] = {{
    file___next_static_js_app_layout_63f4be220d6fa91c_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_84655F75E18F54D7_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_84655f75e18f54d7_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_63f4be220d6fa91c_js)->name = data___next_static_js_app_layout_63f4be220d6fa91c_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_63f4be220d6fa91c_js)->data = data___next_static_js_app_layout_63f4be220d6fa91c_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_84655f75e18f54d7_js)->name = data___next_static_js_app_page_84655f75e18f54d7_js;
    ((struct fsdata_file *)file___next_static_js_app_page_84655f75e18f54d7_js)->data = data___next_static_js_app_page_84655f75e18f54d7_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_63f4be220d6fa91c_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_84655f75e18f54d7_js = (uint8_t*)addr;
        addr += size;
