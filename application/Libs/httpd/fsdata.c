...
static uint8_t* data___next_static_js_app_layout_d9c7f400610299f7_js = NULL;
static uint8_t* data___next_static_js_app_page_a6a6789b94b32a59_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_D9C7F400610299F7_JS 340975
#define SIZE___NEXT_STATIC_JS_APP_PAGE_A6A6789B94B32A59_JS 263714
...
struct fsdata_file file___next_static_js_app_layout_d9c7f400610299f7_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_D9C7F400610299F7_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_a6a6789b94b32a59_js[] = {{
    file___next_static_js_app_layout_d9c7f400610299f7_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_A6A6789B94B32A59_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_a6a6789b94b32a59_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_d9c7f400610299f7_js)->name = data___next_static_js_app_layout_d9c7f400610299f7_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_d9c7f400610299f7_js)->data = data___next_static_js_app_layout_d9c7f400610299f7_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_a6a6789b94b32a59_js)->name = data___next_static_js_app_page_a6a6789b94b32a59_js;
    ((struct fsdata_file *)file___next_static_js_app_page_a6a6789b94b32a59_js)->data = data___next_static_js_app_page_a6a6789b94b32a59_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_d9c7f400610299f7_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_a6a6789b94b32a59_js = (uint8_t*)addr;
        addr += size;
