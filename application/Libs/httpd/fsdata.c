...
static uint8_t* data___next_static_js_app_layout_f24fe465be19b560_js = NULL;
static uint8_t* data___next_static_js_app_page_bc182b063fb7d513_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_F24FE465BE19B560_JS 340485
#define SIZE___NEXT_STATIC_JS_APP_PAGE_BC182B063FB7D513_JS 263214
...
struct fsdata_file file___next_static_js_app_layout_f24fe465be19b560_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_F24FE465BE19B560_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_bc182b063fb7d513_js[] = {{
    file___next_static_js_app_layout_f24fe465be19b560_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_BC182B063FB7D513_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_bc182b063fb7d513_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_f24fe465be19b560_js)->name = data___next_static_js_app_layout_f24fe465be19b560_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_f24fe465be19b560_js)->data = data___next_static_js_app_layout_f24fe465be19b560_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_bc182b063fb7d513_js)->name = data___next_static_js_app_page_bc182b063fb7d513_js;
    ((struct fsdata_file *)file___next_static_js_app_page_bc182b063fb7d513_js)->data = data___next_static_js_app_page_bc182b063fb7d513_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_f24fe465be19b560_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_bc182b063fb7d513_js = (uint8_t*)addr;
        addr += size;
