...
static uint8_t* data___next_static_js_app_layout_f705748fdd637272_js = NULL;
static uint8_t* data___next_static_js_app_page_a733d7a152e2c760_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_F705748FDD637272_JS 359248
#define SIZE___NEXT_STATIC_JS_APP_PAGE_A733D7A152E2C760_JS 274121
...
struct fsdata_file file___next_static_js_app_layout_f705748fdd637272_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_F705748FDD637272_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_a733d7a152e2c760_js[] = {{
    file___next_static_js_app_layout_f705748fdd637272_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_A733D7A152E2C760_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_a733d7a152e2c760_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_f705748fdd637272_js)->name = data___next_static_js_app_layout_f705748fdd637272_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_f705748fdd637272_js)->data = data___next_static_js_app_layout_f705748fdd637272_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_a733d7a152e2c760_js)->name = data___next_static_js_app_page_a733d7a152e2c760_js;
    ((struct fsdata_file *)file___next_static_js_app_page_a733d7a152e2c760_js)->data = data___next_static_js_app_page_a733d7a152e2c760_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_f705748fdd637272_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_a733d7a152e2c760_js = (uint8_t*)addr;
        addr += size;
