...
static uint8_t* data___next_static_js_app_layout_d3c80ac937c31850_js = NULL;
static uint8_t* data___next_static_js_app_page_65f7eee7b2f409db_js = NULL;
...
#define SIZE__INDEX_HTML 30934
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_D3C80AC937C31850_JS 352770
#define SIZE___NEXT_STATIC_JS_APP_PAGE_65F7EEE7B2F409DB_JS 268052
...
struct fsdata_file file___next_static_js_app_layout_d3c80ac937c31850_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_D3C80AC937C31850_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_65f7eee7b2f409db_js[] = {{
    file___next_static_js_app_layout_d3c80ac937c31850_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_65F7EEE7B2F409DB_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_65f7eee7b2f409db_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_d3c80ac937c31850_js)->name = data___next_static_js_app_layout_d3c80ac937c31850_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_d3c80ac937c31850_js)->data = data___next_static_js_app_layout_d3c80ac937c31850_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_65f7eee7b2f409db_js)->name = data___next_static_js_app_page_65f7eee7b2f409db_js;
    ((struct fsdata_file *)file___next_static_js_app_page_65f7eee7b2f409db_js)->data = data___next_static_js_app_page_65f7eee7b2f409db_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_d3c80ac937c31850_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_65f7eee7b2f409db_js = (uint8_t*)addr;
        addr += size;
