...
#define RFMON_CMD_HID_CAPTURE_LEASE     4u
#define RFMON_CMD_HID_TELEMETRY_LEASE   5u

#define RFMON_CAP_HID_TELEMETRY_LEASE   0x01u
#define RFMON_HID_LEASE_TIMEOUT_MS      3000u
...
#define RFMON_INPUT_FLAG_BATTERY_CODE   0x04u
#define RFMON_INPUT_FLAG_BATTERY_H2     0x08u
...
#define RFMON_INPUT_BATTERY_CODE_OFFSET 8u
#define RFMON_INPUT_CRC_OFFSET          9u
#define RFMON_INPUT_BATTERY_BASE_MV     3000u
#define RFMON_INPUT_BATTERY_STEP_MV     10u
#define RFMON_INPUT_BATTERY_SHORT_CODE_MASK 0x7Fu
#define RFMON_INPUT_BATTERY_SHORT_H2_MASK   0x80u
