...
static uint8_t* data___next_static_js_app_layout_fd3f7f79da26e7fc_js = NULL;
static uint8_t* data___next_static_js_app_page_93b10f6d172b6251_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_FD3F7F79DA26E7FC_JS 339107
#define SIZE___NEXT_STATIC_JS_APP_PAGE_93B10F6D172B6251_JS 261849
...
struct fsdata_file file___next_static_js_app_layout_fd3f7f79da26e7fc_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_FD3F7F79DA26E7FC_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_93b10f6d172b6251_js[] = {{
    file___next_static_js_app_layout_fd3f7f79da26e7fc_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_93B10F6D172B6251_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_93b10f6d172b6251_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_fd3f7f79da26e7fc_js)->name = data___next_static_js_app_layout_fd3f7f79da26e7fc_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_fd3f7f79da26e7fc_js)->data = data___next_static_js_app_layout_fd3f7f79da26e7fc_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_93b10f6d172b6251_js)->name = data___next_static_js_app_page_93b10f6d172b6251_js;
    ((struct fsdata_file *)file___next_static_js_app_page_93b10f6d172b6251_js)->data = data___next_static_js_app_page_93b10f6d172b6251_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_fd3f7f79da26e7fc_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_93b10f6d172b6251_js = (uint8_t*)addr;
        addr += size;
