...
void SPIScreenManager::previewBrightness(uint8_t){++g_deviceCommandContractRecording.screenBrightnessPreviews;}
...
bool UserImageCommandHandler::isBackgroundImageAvailable(const char* id){return id&&!strcmp(id,"USER_IMAGE");}
