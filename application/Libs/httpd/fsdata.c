...
static uint8_t* data___next_static_js_app_layout_7d1e282299519e61_js = NULL;
static uint8_t* data___next_static_js_app_page_81bc05a6bf2837bd_js = NULL;
...
#define SIZE__INDEX_HTML 24841
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_7D1E282299519E61_JS 276214
#define SIZE___NEXT_STATIC_JS_APP_PAGE_81BC05A6BF2837BD_JS 198940
...
struct fsdata_file file___next_static_js_app_layout_7d1e282299519e61_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_7D1E282299519E61_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_81bc05a6bf2837bd_js[] = {{
    file___next_static_js_app_layout_7d1e282299519e61_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_81BC05A6BF2837BD_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_81bc05a6bf2837bd_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_7d1e282299519e61_js)->name = data___next_static_js_app_layout_7d1e282299519e61_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_7d1e282299519e61_js)->data = data___next_static_js_app_layout_7d1e282299519e61_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_81bc05a6bf2837bd_js)->name = data___next_static_js_app_page_81bc05a6bf2837bd_js;
    ((struct fsdata_file *)file___next_static_js_app_page_81bc05a6bf2837bd_js)->data = data___next_static_js_app_page_81bc05a6bf2837bd_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_7d1e282299519e61_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_81bc05a6bf2837bd_js = (uint8_t*)addr;
        addr += size;
