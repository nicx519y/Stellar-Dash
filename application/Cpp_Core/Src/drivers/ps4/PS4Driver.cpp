...
#include "drivers/ps4/PS4Auth.hpp"
...
void PS4Driver::process(Gamepad *gamepad)
{
    ...
    case GAMEPAD_MASK_UP:
        ps4Report.dpad = PS4_HAT_UP;
        break;
    case GAMEPAD_MASK_UP | GAMEPAD_MASK_RIGHT:
        ps4Report.dpad = PS4_HAT_UPRIGHT;
        break;
    case GAMEPAD_MASK_RIGHT:
        ps4Report.dpad = PS4_HAT_RIGHT;
        break;
    case GAMEPAD_MASK_DOWN | GAMEPAD_MASK_RIGHT:
        ps4Report.dpad = PS4_HAT_DOWNRIGHT;
        break;
    case GAMEPAD_MASK_DOWN:
        ps4Report.dpad = PS4_HAT_DOWN;
        break;
    case GAMEPAD_MASK_DOWN | GAMEPAD_MASK_LEFT:
        ps4Report.dpad = PS4_HAT_DOWNLEFT;
        break;
    case GAMEPAD_MASK_LEFT:
        ps4Report.dpad = PS4_HAT_LEFT;
        break;
    case GAMEPAD_MASK_UP | GAMEPAD_MASK_LEFT:
        ps4Report.dpad = PS4_HAT_UPLEFT;
        break;
    default:
        ps4Report.dpad = PS4_HAT_NOTHING;
        break;
    }
    ...
    ps4Report.button_select = gamepad->pressedS1();
    ...
    ps4Report.button_touchpad = anyA2A3A4;
...
uint16_t PS4Driver::get_report(uint8_t report_id, hid_report_type_t report_type, uint8_t *buffer, uint16_t reqlen)
{
    ...
    case PS4AuthReport::PS4_GET_CALIBRATION:
        ...
        responseLen = std::max(static_cast<size_t>(reqlen), sizeof(output_0x02));
    ...
    case PS4AuthReport::PS4_GET_MAC_ADDRESS:
        ...
        responseLen = std::max(static_cast<size_t>(reqlen), sizeof(output_0x12));
    ...
    case PS4AuthReport::PS4_GET_VERSION_DATE:
        ...
        responseLen = std::max(static_cast<size_t>(reqlen), sizeof(output_0xa3));
    ...
    case PS4AuthReport::PS4_RESET_AUTH: // Reset the Authentication
        ...
        responseLen = std::max(static_cast<size_t>(reqlen), sizeof(output_0xf3));
