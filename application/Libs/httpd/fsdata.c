...
static uint8_t* data___next_static_js_app_layout_f0cd9d720ddab731_js = NULL;
static uint8_t* data___next_static_js_app_page_47665d22f39a0f13_js = NULL;
...
#define SIZE__INDEX_HTML 30296
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_F0CD9D720DDAB731_JS 350785
#define SIZE___NEXT_STATIC_JS_APP_PAGE_47665D22F39A0F13_JS 266386
...
struct fsdata_file file___next_static_js_app_layout_f0cd9d720ddab731_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_F0CD9D720DDAB731_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_47665d22f39a0f13_js[] = {{
    file___next_static_js_app_layout_f0cd9d720ddab731_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_47665D22F39A0F13_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_47665d22f39a0f13_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_f0cd9d720ddab731_js)->name = data___next_static_js_app_layout_f0cd9d720ddab731_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_f0cd9d720ddab731_js)->data = data___next_static_js_app_layout_f0cd9d720ddab731_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_47665d22f39a0f13_js)->name = data___next_static_js_app_page_47665d22f39a0f13_js;
    ((struct fsdata_file *)file___next_static_js_app_page_47665d22f39a0f13_js)->data = data___next_static_js_app_page_47665d22f39a0f13_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_f0cd9d720ddab731_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_47665d22f39a0f13_js = (uint8_t*)addr;
        addr += size;
