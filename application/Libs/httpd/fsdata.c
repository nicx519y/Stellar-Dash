...
static uint8_t* data___next_static_js_app_layout_c178c6e18ac44ff2_js = NULL;
static uint8_t* data___next_static_js_app_page_50d357f0ec796988_js = NULL;
...
#define SIZE__INDEX_HTML 24840
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_C178C6E18AC44FF2_JS 276280
#define SIZE___NEXT_STATIC_JS_APP_PAGE_50D357F0EC796988_JS 198996
...
struct fsdata_file file___next_static_js_app_layout_c178c6e18ac44ff2_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_C178C6E18AC44FF2_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_50d357f0ec796988_js[] = {{
    file___next_static_js_app_layout_c178c6e18ac44ff2_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_50D357F0EC796988_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_50d357f0ec796988_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_c178c6e18ac44ff2_js)->name = data___next_static_js_app_layout_c178c6e18ac44ff2_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_c178c6e18ac44ff2_js)->data = data___next_static_js_app_layout_c178c6e18ac44ff2_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_50d357f0ec796988_js)->name = data___next_static_js_app_page_50d357f0ec796988_js;
    ((struct fsdata_file *)file___next_static_js_app_page_50d357f0ec796988_js)->data = data___next_static_js_app_page_50d357f0ec796988_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_c178c6e18ac44ff2_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_50d357f0ec796988_js = (uint8_t*)addr;
        addr += size;
