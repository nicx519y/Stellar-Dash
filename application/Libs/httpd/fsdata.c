...
static uint8_t* data___next_static_js_app_layout_92022316b450a100_js = NULL;
static uint8_t* data___next_static_js_app_page_08ebe3fa3d3bb032_js = NULL;
...
#define SIZE__INDEX_HTML 23428
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_92022316B450A100_JS 342319
#define SIZE___NEXT_STATIC_JS_APP_PAGE_08EBE3FA3D3BB032_JS 264266
...
struct fsdata_file file___next_static_js_app_layout_92022316b450a100_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_92022316B450A100_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_08ebe3fa3d3bb032_js[] = {{
    file___next_static_js_app_layout_92022316b450a100_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_08EBE3FA3D3BB032_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_08ebe3fa3d3bb032_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_92022316b450a100_js)->name = data___next_static_js_app_layout_92022316b450a100_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_92022316b450a100_js)->data = data___next_static_js_app_layout_92022316b450a100_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_08ebe3fa3d3bb032_js)->name = data___next_static_js_app_page_08ebe3fa3d3bb032_js;
    ((struct fsdata_file *)file___next_static_js_app_page_08ebe3fa3d3bb032_js)->data = data___next_static_js_app_page_08ebe3fa3d3bb032_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_92022316b450a100_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_08ebe3fa3d3bb032_js = (uint8_t*)addr;
        addr += size;
