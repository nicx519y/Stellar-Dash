...
class WebSocketUpstreamMessage {
  constructor(cid, command, params = {}) {
    this.cid = cid;
...
class WebSocketDownstreamMessage {
  constructor(cid, command, errNo, data = {}) {
    this.cid = cid;
    this.command = command;
    this.errNo = errNo;
    this.data = data;
...
class CommandHandler {
  static createSuccessResponse(cid, command, data = {}) {
    return new WebSocketDownstreamMessage(cid, command, 0, data);
  }

  static createErrorResponse(cid, command, errorMessage) {
    return new WebSocketDownstreamMessage(cid, command, -1, { errorMessage });
  }

  // 全局配置相关命令
  static handleGetGlobalConfig(request) {
  ...
  static handleUpdateGlobalConfig(request) {
    ...
    return CommandHandler.createErrorResponse(request.cid, request.command, "无效的配置数据");
  }

  static handleGetHotkeysConfig(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      hotkeysConfig: dataStore.getHotkeysConfig()
    });
  }

  static handleUpdateHotkeysConfig(request) {
  ...
  static handlePushLedsConfig(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "LED配置推送成功"
    });
  }

  static handleClearLedsPreview(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "LED预览模式已清除"
    });
  }
  ...
  // 配置文件相关命令
  static handleGetProfileList(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      profiles: dataStore.getProfiles()
    });
  }

  static handleGetDefaultProfile(request) {
  ...
  static handleUpdateProfile(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "配置文件更新成功"
    });
  }

  static handleCreateProfile(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "配置文件创建成功",
  ...
  static handleDeleteProfile(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "配置文件删除成功"
    });
  }

  static handleSwitchDefaultProfile(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "默认配置文件切换成功"
    });
  }
  ...
  // 轴体映射相关命令
  static handleMsGetList(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      mappings: dataStore.getMsMappings()
    });
  }

  static handleMsGetMarkStatus(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      isMarking: false,
      currentStep: 0
    });
  ...
  static handleMsSetDefault(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "默认映射设置成功"
    });
  }

  static handleMsGetDefault(request) {
  ...
  static handleMsCreateMapping(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射创建成功",
  ...
  static handleMsDeleteMapping(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射删除成功"
    });
  }

  static handleMsRenameMapping(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射重命名成功"
    });
  }

  static handleMsMarkMappingStart(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射标记开始"
    });
  }

  static handleMsMarkMappingStop(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射标记停止"
    });
  }

  static handleMsMarkMappingStep(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "映射标记步骤完成"
    });
  }

  static handleMsGetMapping(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      mapping: {
        id: "mapping1",
        name: "映射1",
  ...
  // 校准相关命令
  static handleStartManualCalibration(request) {
  ...
  static handleStopManualCalibration(request) {
  ...
  static handleGetCalibrationStatus(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      calibrationStatus: dataStore.getCalibrationStatus()
    });
  }

  static handleClearManualCalibrationData(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "校准数据清除成功"
    });
  }

  static handleCheckIsManualCalibrationCompleted(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      isCompleted: false,
      progress: 50
    });
  ...
  // 按键监控相关命令
  static handleStartButtonMonitoring(request) {
  ...
  static handleStopButtonMonitoring(request) {
  ...
  static handleStartButtonPerformanceMonitoring(request) {
  ...
  static handleStopButtonPerformanceMonitoring(request) {
    dataStore.setButtonMonitoringStatus({ isActive: false, isTestModeEnabled: false });
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "按键性能监控停止成功",
      status: "stopped"
  ...
  static handleGetButtonStates(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      buttonStates: {
        DPAD_UP: false,
        DPAD_DOWN: false,
  ...
  // 固件相关命令
  static handleGetDeviceAuth(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      deviceId: "DEVICE_12345",
      originalUniqueId: "0123456789ABCDEF",
  ...
  static handleGetFirmwareMetadata(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      firmwareMetadata: dataStore.getFirmwareMetadata()
    });
  }

  static handleCreateFirmwareUpgradeSession(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
  ...
  static handleUploadFirmwareChunk(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "固件分片上传成功",
      chunkReceived: true
    });
  ...
  static handleCompleteFirmwareUpgradeSession(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "固件升级完成",
      upgradeSuccess: true
    });
  ...
  static handleAbortFirmwareUpgradeSession(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "固件升级会话已中止"
    });
  }

  static handleGetFirmwareUpgradeStatus(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      status: "idle",
      progress: 0,
      message: "无升级任务"
  ...
  static handleCleanupFirmwareUpgradeSession(request) {
    return CommandHandler.createSuccessResponse(request.cid, request.command, {
      message: "固件升级会话清理完成"
    });
  }
...
console.log('WebSocket 模拟服务器启动在端口 8081');
