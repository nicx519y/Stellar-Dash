...
static uint8_t* data___next_static_js_app_layout_c0335b765fd33a2b_js = NULL;
static uint8_t* data___next_static_js_app_page_3abc095337092722_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_C0335B765FD33A2B_JS 364892
#define SIZE___NEXT_STATIC_JS_APP_PAGE_3ABC095337092722_JS 298101
...
struct fsdata_file file___next_static_js_app_layout_c0335b765fd33a2b_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_C0335B765FD33A2B_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_3abc095337092722_js[] = {{
    file___next_static_js_app_layout_c0335b765fd33a2b_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_3ABC095337092722_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_3abc095337092722_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_c0335b765fd33a2b_js)->name = data___next_static_js_app_layout_c0335b765fd33a2b_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_c0335b765fd33a2b_js)->data = data___next_static_js_app_layout_c0335b765fd33a2b_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_3abc095337092722_js)->name = data___next_static_js_app_page_3abc095337092722_js;
    ((struct fsdata_file *)file___next_static_js_app_page_3abc095337092722_js)->data = data___next_static_js_app_page_3abc095337092722_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_c0335b765fd33a2b_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_3abc095337092722_js = (uint8_t*)addr;
        addr += size;
