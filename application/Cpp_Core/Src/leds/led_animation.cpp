...
const ButtonPosition HITBOX_LED_POS_LIST[NUM_LED + NUM_LED_AROUND] = {
    { 120.19f, 123.51f, 21.50f },      // 0
    { 147.24f, 130.70f, 21.50f },   // 1
    { 174.30f, 123.51f, 21.50f },   // 2
    { 198.48f, 117.14f, 21.50f },   // 3
    { 73.39f, 63.66f, 21.50f },   // 4
    { 98.95f, 59.57f, 21.50f },   // 5
    { 122.09f, 63.66f, 21.50f },   // 6
    { 141.34f, 77.13f, 21.50f },   // 7
    { 131.09f, 41.94f, 21.50f },   // 8
    { 168.08f, 79.30f, 21.50f },   // 9
    { 157.34f, 56.87f, 21.50f },    // 10
    { 155.16f, 31.97f, 21.50f },   // 11
    { 188.56f, 64.96f, 21.50f },    // 12
    { 177.82f, 42.53f, 21.50f },    // 13
    { 212.05f, 56.41f, 21.50f },   // 14
    { 201.31f, 33.98f, 21.50f },    // 15
    { 236.96f, 54.23f, 21.50f },    // 16
    { 226.22f, 31.80f, 21.50f },    // 17
    { 84.39f, 15.39f, 21.50f },     // 18
    { 62.39f, 15.39f, 21.50f },      // 19
    { 40.39f, 15.39f, 21.50f },      // 20
    { 18.39f, 15.39f, 21.50f },      // 21

    #if HAS_LED_AROUND
    { 48.50f, 13.00f, 5.40f },    // 22
    { 30.75f, 13.00f, 5.40f },    // 23
    { 13.00f, 13.0f, 5.40f },    // 24
    { 13.00f, 33.50f, 5.40f },    // 25
    { 13.00f, 54.00f, 5.40f },    // 26
    { 13.00, 74.50f, 5.40f },    // 27
    { 13.00f, 95.00f, 5.40f },    // 28
    { 13.00f, 115.50f, 5.40f },    // 29
    { 13.00f, 136.00f, 5.40f },    // 30
    { 13.00f, 156.50f, 5.40f },    // 31
    { 13.00f, 177.00f, 5.40f },    // 32
    { 30.75f, 177.00f, 5.40f },    // 33
    { 48.50f, 177.00f, 5.40f },    // 34
    { 66.25f, 177.00f, 5.40f },    // 35
    { 84.00f, 177.00f, 5.40f },    // 36
    { 101.75f, 177.00f, 5.40f },    // 37
    { 119.50f, 177.00f, 5.40f },    // 38
    { 137.25f, 177.00f, 5.40f },    // 39
    { 155.00f, 177.00f, 5.40f },    // 40
    { 172.75f, 177.00f, 5.40f },    // 41
    { 190.50f, 177.00f, 5.40f },    // 42
    { 208.25f, 177.00f, 5.40f },    // 43
    { 226.00f, 177.00f, 5.40f },    // 44
    { 243.75f, 177.00f, 5.40f },    // 45
    { 261.50f, 177.00f, 5.40f },    // 46
    { 279.25f, 177.00f, 5.40f },    // 47
    { 297.00f, 177.00f, 5.40f },    // 48
    { 297.00f, 156.50f, 5.40f },    // 49
    { 297.00f, 136.00f, 5.40f },    // 50
    { 297.00f, 115.50f, 5.40f },    // 51
    { 297.00f, 95.00f, 5.40f },    // 52
    { 297.00f, 74.50f, 5.40f },    // 53
    { 297.00f, 54.00f, 5.40f },    // 54
    { 297.00f, 33.50f, 5.40f },    // 55
    { 297.00f, 13.00f, 5.40f },    // 56
    { 279.25f, 13.00f, 5.40f },    // 57
    { 261.50f, 13.00f, 5.40f }    // 58
