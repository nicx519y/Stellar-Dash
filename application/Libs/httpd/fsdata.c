...
static uint8_t* data___next_static_js_app_layout_233246910c2b7570_js = NULL;
static uint8_t* data___next_static_js_app_page_67f0bdcb6ea7b12e_js = NULL;
...
#define SIZE__INDEX_HTML 23429
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_233246910C2B7570_JS 348674
#define SIZE___NEXT_STATIC_JS_APP_PAGE_67F0BDCB6EA7B12E_JS 270551
...
struct fsdata_file file___next_static_js_app_layout_233246910c2b7570_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_233246910C2B7570_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_67f0bdcb6ea7b12e_js[] = {{
    file___next_static_js_app_layout_233246910c2b7570_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_67F0BDCB6EA7B12E_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_67f0bdcb6ea7b12e_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_233246910c2b7570_js)->name = data___next_static_js_app_layout_233246910c2b7570_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_233246910c2b7570_js)->data = data___next_static_js_app_layout_233246910c2b7570_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_67f0bdcb6ea7b12e_js)->name = data___next_static_js_app_page_67f0bdcb6ea7b12e_js;
    ((struct fsdata_file *)file___next_static_js_app_page_67f0bdcb6ea7b12e_js)->data = data___next_static_js_app_page_67f0bdcb6ea7b12e_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_233246910c2b7570_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_67f0bdcb6ea7b12e_js = (uint8_t*)addr;
        addr += size;
