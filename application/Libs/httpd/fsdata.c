...
static uint8_t* data___next_static_js_app_layout_b126778ea3919bf4_js = NULL;
static uint8_t* data___next_static_js_app_page_7b67848d6afb8491_js = NULL;
...
#define SIZE__INDEX_HTML 24707
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_B126778EA3919BF4_JS 320448
#define SIZE___NEXT_STATIC_JS_APP_PAGE_7B67848D6AFB8491_JS 243515
...
struct fsdata_file file___next_static_js_app_layout_b126778ea3919bf4_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_B126778EA3919BF4_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_7b67848d6afb8491_js[] = {{
    file___next_static_js_app_layout_b126778ea3919bf4_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_7B67848D6AFB8491_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_7b67848d6afb8491_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_b126778ea3919bf4_js)->name = data___next_static_js_app_layout_b126778ea3919bf4_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_b126778ea3919bf4_js)->data = data___next_static_js_app_layout_b126778ea3919bf4_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_7b67848d6afb8491_js)->name = data___next_static_js_app_page_7b67848d6afb8491_js;
    ((struct fsdata_file *)file___next_static_js_app_page_7b67848d6afb8491_js)->data = data___next_static_js_app_page_7b67848d6afb8491_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_b126778ea3919bf4_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_7b67848d6afb8491_js = (uint8_t*)addr;
        addr += size;
