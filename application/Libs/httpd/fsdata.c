...
static uint8_t* data___next_static_js_app_layout_03d377f25242b058_js = NULL;
static uint8_t* data___next_static_js_app_page_6a7467c6f9c1b205_js = NULL;
...
#define SIZE__INDEX_HTML 17619
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_03D377F25242B058_JS 364210
#define SIZE___NEXT_STATIC_JS_APP_PAGE_6A7467C6F9C1B205_JS 297388
...
struct fsdata_file file___next_static_js_app_layout_03d377f25242b058_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_03D377F25242B058_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_6a7467c6f9c1b205_js[] = {{
    file___next_static_js_app_layout_03d377f25242b058_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_6A7467C6F9C1B205_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_6a7467c6f9c1b205_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_03d377f25242b058_js)->name = data___next_static_js_app_layout_03d377f25242b058_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_03d377f25242b058_js)->data = data___next_static_js_app_layout_03d377f25242b058_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_6a7467c6f9c1b205_js)->name = data___next_static_js_app_page_6a7467c6f9c1b205_js;
    ((struct fsdata_file *)file___next_static_js_app_page_6a7467c6f9c1b205_js)->data = data___next_static_js_app_page_6a7467c6f9c1b205_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_03d377f25242b058_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_6a7467c6f9c1b205_js = (uint8_t*)addr;
        addr += size;
