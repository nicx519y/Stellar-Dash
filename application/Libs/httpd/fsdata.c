...
static uint8_t* data___next_static_js_app_layout_d231d556e1fd1144_js = NULL;
static uint8_t* data___next_static_js_app_page_f05847a61868f07d_js = NULL;
...
#define SIZE__INDEX_HTML 24466
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_D231D556E1FD1144_JS 253979
#define SIZE___NEXT_STATIC_JS_APP_PAGE_F05847A61868F07D_JS 194907
...
struct fsdata_file file___next_static_js_app_layout_d231d556e1fd1144_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_D231D556E1FD1144_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_f05847a61868f07d_js[] = {{
    file___next_static_js_app_layout_d231d556e1fd1144_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_F05847A61868F07D_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_f05847a61868f07d_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_d231d556e1fd1144_js)->name = data___next_static_js_app_layout_d231d556e1fd1144_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_d231d556e1fd1144_js)->data = data___next_static_js_app_layout_d231d556e1fd1144_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_f05847a61868f07d_js)->name = data___next_static_js_app_page_f05847a61868f07d_js;
    ((struct fsdata_file *)file___next_static_js_app_page_f05847a61868f07d_js)->data = data___next_static_js_app_page_f05847a61868f07d_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_d231d556e1fd1144_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_f05847a61868f07d_js = (uint8_t*)addr;
        addr += size;
