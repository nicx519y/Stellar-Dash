...
static uint8_t* data___next_static_js_app_layout_bfc0e99d1b47d348_js = NULL;
static uint8_t* data___next_static_js_app_page_d48868473878d5b4_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_BFC0E99D1B47D348_JS 276231
#define SIZE___NEXT_STATIC_JS_APP_PAGE_D48868473878D5B4_JS 198946
...
struct fsdata_file file___next_static_js_app_layout_bfc0e99d1b47d348_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_BFC0E99D1B47D348_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_d48868473878d5b4_js[] = {{
    file___next_static_js_app_layout_bfc0e99d1b47d348_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_D48868473878D5B4_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_d48868473878d5b4_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_bfc0e99d1b47d348_js)->name = data___next_static_js_app_layout_bfc0e99d1b47d348_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_bfc0e99d1b47d348_js)->data = data___next_static_js_app_layout_bfc0e99d1b47d348_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_d48868473878d5b4_js)->name = data___next_static_js_app_page_d48868473878d5b4_js;
    ((struct fsdata_file *)file___next_static_js_app_page_d48868473878d5b4_js)->data = data___next_static_js_app_page_d48868473878d5b4_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_bfc0e99d1b47d348_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_d48868473878d5b4_js = (uint8_t*)addr;
        addr += size;
