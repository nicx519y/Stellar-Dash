...
static uint8_t* data___next_static_js_app_layout_3cc92f2072a57929_js = NULL;
static uint8_t* data___next_static_js_app_page_b601cae2f8d297b7_js = NULL;
...
#define SIZE___NEXT_STATIC_JS_APP_LAYOUT_3CC92F2072A57929_JS 350691
#define SIZE___NEXT_STATIC_JS_APP_PAGE_B601CAE2F8D297B7_JS 272607
...
struct fsdata_file file___next_static_js_app_layout_3cc92f2072a57929_js[] = {{
    file__index_html,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_LAYOUT_3CC92F2072A57929_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app_page_b601cae2f8d297b7_js[] = {{
    file___next_static_js_app_layout_3cc92f2072a57929_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
    SIZE___NEXT_STATIC_JS_APP_PAGE_B601CAE2F8D297B7_JS - 48,
    FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT
}};

struct fsdata_file file___next_static_js_app__not_found_page_74cc9060c45c4b1e_js[] = {{
    file___next_static_js_app_page_b601cae2f8d297b7_js,
    NULL,  // 将在运行时设置
    NULL,  // 将在运行时设置
...
static void update_file_pointers(void) {
    ...
    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_layout_3cc92f2072a57929_js)->name = data___next_static_js_app_layout_3cc92f2072a57929_js;
    ((struct fsdata_file *)file___next_static_js_app_layout_3cc92f2072a57929_js)->data = data___next_static_js_app_layout_3cc92f2072a57929_js + 48;

    // 更新undefined的指针
    ((struct fsdata_file *)file___next_static_js_app_page_b601cae2f8d297b7_js)->name = data___next_static_js_app_page_b601cae2f8d297b7_js;
    ((struct fsdata_file *)file___next_static_js_app_page_b601cae2f8d297b7_js)->data = data___next_static_js_app_page_b601cae2f8d297b7_js + 48;
...
const struct fsdata_file * getFSRoot(void)
{
    if(fsdata_inited == false) {
        ...
        data___next_static_js_app_layout_3cc92f2072a57929_js = (uint8_t*)addr;
        addr += size;

        size = read_uint32_be(base_ptr + 16);
        data___next_static_js_app_page_b601cae2f8d297b7_js = (uint8_t*)addr;
        addr += size;
